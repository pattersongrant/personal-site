    ...
    <section>
      ...
      <div className="flex flex-wrap">
        <div className="mr-8 mb-8 w-40">
          ...
          <img src="cmaxlogo.png" alt="Charismax logo" className="w-16 h-16 object-cover rounded-lg border border-black mb-3" />
          <img src="charismax.png" alt="Charismax App Store screenshot" className="w-40 rounded-lg border border-black" />
        ...
        <div className="mr-8 mb-8 w-40">
          ...
          <img src="M.png" alt="M-Cals logo" className="w-16 h-16 object-cover rounded-lg border border-black mb-3" />
          <img src="mcalsscreenshot.png" alt="M-Cals App Store screenshot" className="w-40 rounded-lg border border-black" />
        ...
        <div className="mr-8 mb-8">
          ...
          <img src="mwrap.png" alt="Musicwrap" className="w-36 h-36 object-cover rounded-lg border border-black" />
        ...
        <div className="mr-8 mb-8">
          ...
          <img src="playlists.png" alt="Playlist Publicizer" className="w-36 h-36 object-cover rounded-lg border border-black" />
        ...
        <div className="mb-8">
          ...
          <img src="llmnews.png" alt="llmnewsapp" className="w-36 h-36 object-cover rounded-lg border border-black" />
