...
export default function Home() {
  return (
    <main className="h-full p-10 flex items-end">
        <h1 className="sm:text-9xl text-3xl text-white font-sans font-bold align-middle mx-auto my-auto hover:text-sky-800 duration-200">Grant Patterson</h1>
        <div className="w-2/5 ml-auto">
          ...
          <div className="shadow-2xl" id="scoreaxis-widget-96e18" style={{ borderWidth: '0px', borderColor: 'rgba(0, 0, 0, 0.15)', borderStyle: 'solid', borderRadius: '8px', padding: '10px', background: 'rgb(255, 255, 255)', width: '100%', container: '1px', maxHeight: '100vh', overflow: 'auto' }}>
