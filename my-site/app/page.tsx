  ...
  return (
    <main className="h-full p-10 sm:flex items-end">
        ...
        <div className="sm:w-2/5 ml-auto">
          ...
          <div className="shadow-2xl" id="scoreaxis-widget-96e18" style={{ borderWidth: '0px', borderColor: 'rgba(0, 0, 0, 0.15)', borderStyle: 'solid', borderRadius: '8px', padding: '10px', background: 'rgb(255, 255, 255)', width: '100%', container: '1px', maxHeight: '80vh', overflow: 'auto', marginBottom: 'auto'}}>
